...
// const SparkleIcon = () => (
//     <svg width="11" height="11" viewBox="0 0 24 24" fill="currentColor" style={{ display:'inline', verticalAlign:'middle', marginRight:3 }}>
...
//                 .nb-dropdown{position:absolute;right:0;top:calc(100% + 14px);background:var(--clr-cream);border:1.5px solid var(--clr-sand);box-shadow:0 12px 36px rgba(61,35,24,0.16);border-radius:14px;overflow:hidden;min-width:162px;z-index:500;}
...
//                 .nb-dd-item{padding:12px 20px;font-size:0.82rem;color:var(--clr-brown);letter-spacing:0.04em;font-weight:600;cursor:pointer;border-bottom:1px solid rgba(237,216,196,0.6);transition:background 0.18s,color 0.18s,padding-left 0.18s;display:flex;align-items:center;gap:10px;}
//                 .nb-dd-item:last-child{border-bottom:none;}
//                 .nb-dd-item:hover{background:rgba(201,106,66,0.09);color:var(--clr-terra);padding-left:26px;}
...
//                 .nb-sidebar-link{padding:15px 24px;font-size:0.78rem;letter-spacing:0.12em;font-weight:700;color:var(--clr-brown);text-decoration:none;border-bottom:1px solid rgba(237,216,196,0.6);transition:background 0.2s,color 0.2s,padding-left 0.2s;display:block;cursor:pointer;}
...
//                             <motion.button className={`nb-icon-btn nb-profile-btn ${dropdownOpen ? 'is-open' : ''}`}
...
//                                         <div className="nb-dd-item" onClick={() => { setDropdownOpen(false); navigate('/profile') }}>
//                                             <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
//                                             My Profile
//                                         </div>
//                                         <div className="nb-dd-item" onClick={() => { setDropdownOpen(false); navigate('/orders') }}>
...
//                                             Orders
//                                         </div>
//                                         <div className="nb-dd-item" onClick={() => { setDropdownOpen(false); navigate('/ai-recommendations') }}>
...
//                                             AI Picks
//                                         </div>
//                                         <div className="nb-dd-item" onClick={logout} style={{ color: '#C96A42' }}>
...
//                                 style={{ marginTop: 'auto', borderTop: '1px solid rgba(237,216,196,0.6)' }}>
...
//                                 <div className="nb-sidebar-link" style={{ color: '#C96A42' }} onClick={logout}>LOGOUT</div>
//                             </motion.div>
//                         )}
//                     </motion.div>
//                 )}
