...
const PlaceOrder = () => {
    ...
    return (
        <>
            ...
            <form onSubmit={onSubmitHandler} className="po-page flex flex-col justify-between gap-8 sm:flex-row">
                ...
                >
                    <div className="my-2"><Title text1="DELIVERY" text2="INFORMATION" /></div>
                    <p className="section-label">Shipping details</p>

                    <div className="flex gap-3">
                        <input onChange={onChangeHandler} name="firstName" value={formData.firstName} required className="form-inp" type="text" placeholder="First name" />
                        <input onChange={onChangeHandler} name="lastName" value={formData.lastName} required className="form-inp" type="text" placeholder="Last name" />
                    </div>
                    <input onChange={onChangeHandler} name="email" value={formData.email} required className="form-inp" type="email" placeholder="Email address" />
                    <input onChange={onChangeHandler} name="street" value={formData.street} required className="form-inp" type="text" placeholder="Street address" />
                    <div className="flex gap-3">
                        <input onChange={onChangeHandler} name="city" value={formData.city} required className="form-inp" type="text" placeholder="City" />
                        <input onChange={onChangeHandler} name="state" value={formData.state} required className="form-inp" type="text" placeholder="State" />
                    </div>
                    <div className="flex gap-3">
                        <input onChange={onChangeHandler} name="zipcode" value={formData.zipcode} required className="form-inp" type="text" placeholder="Zipcode" />
                        <input onChange={onChangeHandler} name="country" value={formData.country} required className="form-inp" type="text" placeholder="Country" />
                    </div>
                    <input onChange={onChangeHandler} name="phone" value={formData.phone} required className="form-inp" type="tel" placeholder="Phone number" />
                </motion.div>
                ...
                >
                    ...
                    <div>
                        <div style={{ marginBottom: 16 }}><Title text1="PAYMENT" text2="METHOD" /></div>
                        ...
                        <div className="flex flex-col gap-3 lg:flex-row">
                            {[
                                ...
                                <motion.div key={key} onClick={() => setMethod(key)} className={`pay-opt ${method === key ? 'sel' : ''}`} whileTap={{ scale: 0.97 }}>
                                    <span className="pay-radio" />
                                    <img className="pay-logo" src={logo} alt={key} />
                                </motion.div>
                            ))}
                            <motion.div onClick={() => setMethod('cod')} className={`pay-opt ${method === 'cod' ? 'sel' : ''}`} whileTap={{ scale: 0.97 }}>
                                <span className="pay-radio" />
                                <span style={{ fontSize: '0.78rem', fontWeight: 700, color: '#3D2318', letterSpacing: '0.08em', textTransform: 'uppercase' }}>Cash on Delivery</span>
                            </motion.div>
                        </div>
